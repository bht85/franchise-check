    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <aside className="w-64 bg-[#111827] text-white flex flex-col hidden md:flex">
        ...
        <nav className="flex-1 px-4 py-4 space-y-1">
          <Link href="/admin" className="flex items-center gap-3 px-3 py-2 bg-[#1f2937] rounded-lg text-white">
            <LayoutDashboard size={20} className="text-indigo-400" />
            <span className="font-medium">대시보드</span>
          </Link>
          <Link href="/dashboard" className="flex items-center gap-3 px-3 py-2 text-gray-400 hover:bg-[#1f2937] hover:text-white rounded-lg transition-colors mt-8">
            <LogOut size={20} />
